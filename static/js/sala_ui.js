...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.createFloatingEmoji = function(emoji) {
        ...
        Object.assign(d.style,{position:'fixed',left:(Math.random()*80+10)+'%',bottom:'0',
    ...
    function emitBoxState(el){
        ...
        socket.emit('box_state',{room:ROOM_ID,socket_id:el.id.replace('participant-',''),
    ...
    window.drawLine=function(x0,y0,x1,y1,mode,shouldEmit){
        ...
        wctx.lineWidth  =(mode==='eraser')?30:3;
        wctx.strokeStyle=(mode==='eraser')?CANVAS_BG:'#ffffff';
    ...
    function renderChart(d){
        ...
        reactionChart=new Chart(chartCanvas.getContext('2d'),{type:'bar',
